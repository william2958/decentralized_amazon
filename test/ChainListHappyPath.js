...
contract('ChainList', function(accounts) {
    ...
    // Test case: should check events - DEPRECIATED, replaced with the two sell tests above
    ...
    it("should let us buy the first article", function() {
        return ChainList.deployed().then(function(instance) {
            ...
            assert(data.length, 1, "there should now only be one article left for sale");
        });
    });
